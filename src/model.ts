...
export const COUNTRY_CONFIG: Record<Country, CountryConfig> = {
  ...
  [Country.BELGIUM]: {
    ...
    indeedDomain: 'be',
    indeedApiCode: 'BE',
    glassdoorDomain: 'fr.glassdoor.be',
  },
  [Country.BRAZIL]: {
    names: ['brazil'],
    indeedDomain: 'br',
  ...
  [Country.CZECHREPUBLIC]: {
    names: ['czech republic', 'czechia', 'czechrepublic'],
    indeedDomain: 'cz',
    indeedApiCode: 'CZ',
  },
  ...
  [Country.SAUDIARABIA]: {
    names: ['saudi arabia', 'saudiarabia'],
    indeedDomain: 'sa',
    indeedApiCode: 'SA',
  },
  [Country.SINGAPORE]: {
  ...
  [Country.SOUTHAFRICA]: {
    names: ['south africa', 'southafrica'],
    indeedDomain: 'za',
    indeedApiCode: 'ZA',
  },
  [Country.SOUTHKOREA]: {
    names: ['south korea', 'southkorea'],
    indeedDomain: 'kr',
    indeedApiCode: 'KR',
  },
  [Country.SPAIN]: {
  ...
  [Country.SWITZERLAND]: {
    ...
    indeedDomain: 'ch',
    indeedApiCode: 'CH',
    glassdoorDomain: 'de.glassdoor.ch',
  },
  ...
  [Country.UNITEDARABEMIRATES]: {
    names: ['united arab emirates', 'uae', 'unitedarabemirates'],
    indeedDomain: 'ae',
    indeedApiCode: 'AE',
  },
  [Country.UK]: {
